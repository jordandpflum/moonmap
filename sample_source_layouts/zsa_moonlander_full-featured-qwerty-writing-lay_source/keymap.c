...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_GRAVE,       KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_6,                                           DUAL_FUNC_1,    KC_LCBR,        KC_RCBR,        KC_LBRC,        KC_RBRC,        KC_MINUS,       KC_EQUAL,       
    KC_TAB,         KC_Q,           KC_W,           KC_E,           KC_R,           KC_T,           KC_7,                                           KC_MEH,         KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLS,        
    MT(MOD_LCTL, KC_ESCAPE),KC_A,           KC_S,           KC_D,           KC_F,           KC_G,           KC_8,                                                                           KC_HYPR,        KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_QUOTE,       
    KC_CAPS,        KC_Z,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_SLASH,       SC_RSPC,        
    TT(2),          KC_LEFT_GUI,    KC_9,           KC_0,           KC_LEFT_CTRL,   DUAL_FUNC_0,                                                                                                    LT(4, KC_ENTER),KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       TT(3),          
    KC_LEFT_ALT,    LT(3, KC_SPACE),KC_LEFT_SHIFT,                  MT(MOD_RCTL, KC_DELETE),LT(2, KC_SPACE),MT(MOD_RALT, KC_BSPC)
  ),
  [1] = LAYOUT_moonlander(
    ...
    TT(2),          DUAL_FUNC_2,    KC_9,           KC_0,           KC_ENTER,       MO(4),                                                                                                          LT(4, KC_ENTER),KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       TT(3),          
  ...
  [2] = LAYOUT_moonlander(
    ...
    DUAL_FUNC_3,    KC_F11,         KC_F12,         KC_KP_1,        KC_KP_2,        KC_KP_3,                                        KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_ENTER,    KC_TRANSPARENT, DUAL_FUNC_4,    
  ...
  [3] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_MS_ACCEL0,   KC_MS_ACCEL1,   KC_MS_ACCEL2,   KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_AUDIO_MUTE,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, QK_BOOT,        
